...
try:
    ...
    def carregar_dados_github():
        url_df_final_1 = "https://raw.githubusercontent.com/pesquisaitr-cmd/PNAD/main/dados/df_final1.parquet"
        url_df_final_2 = "https://raw.githubusercontent.com/pesquisaitr-cmd/PNAD/main/dados/df_final2.parquet"
        url_df_final_3 = "https://raw.githubusercontent.com/pesquisaitr-cmd/PNAD/main/dados/df_final3.parquet"
        url_df_inpc = "https://raw.githubusercontent.com/pesquisaitr-cmd/PNAD/main/dados/df_inpc.parquet"

        # Carregar os 3 pedaços com engine explícita
        df1 = pd.read_parquet(url_df_final_1, engine="pyarrow")
        df2 = pd.read_parquet(url_df_final_2, engine="pyarrow")
        df3 = pd.read_parquet(url_df_final_3, engine="pyarrow")

        # Concatenar
        df_final = pd.concat([df1, df2, df3], ignore_index=True)

        # Carregar INPC
        df_inpc = pd.read_parquet(url_df_inpc, engine="pyarrow")
